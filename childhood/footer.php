<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                <div class="reply__title">
                  ...
                  <?php echo do_shortcode('[contact-form-7 id="142" title="Форма вопросов"]');?>
            </div>
        </div>
        <footer>
            <div class="container">
        ...
        <?php
            wp_footer();
        ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD_7ROfcZOtOnCKqvhphmdndHQYVY2QN2Y"></script> 
